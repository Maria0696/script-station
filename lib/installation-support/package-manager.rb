...
module InstallationSupport
  class PackageManager
    ...
    def initialize
      Signal.trap('INT') do
        puts "\nExiting package manager installer...".red
        exit
      end
    end
...
def main
  ...
  manager = InstallationSupport::PackageManager.new

  operating_system = prompt.select(
    'Select your operating system:',
    manager.list_operating_systems
  )

  manager.install_package_manager(operating_system)
end
